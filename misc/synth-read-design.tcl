...
# analyze -format sverilog /mnt/vault0/rsunketa/test/openfpga-test-runs/FPL_2025/router_files/axis_router/src/axis_serdes_shims.sv

# Analyze the RTL source file
set design_files_path /mnt/vault0/rsunketa/router-parameter-sweep/run-files/rtl
read_file $design_files_path -autoread -format sverilog -top $dc_design_name
